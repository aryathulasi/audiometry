...
$sql = 'update t_test set 500Hz=:value where testid=:testid';
...
<body class="single-page">
    ...
    <!--div class="med-history">
            ...
            <link href="style.css" rel="stylesheet" type="text/css" />
            	...
            	<form name="form1" action="step8.php" method="post">
                <table width="585" height="298">
<tr>
       	  				<td height="50" colspan="2"><div class="btitle">1 KiloHZ</div></td>
           	  	  </tr>
                  <tr>
               	   	   <td width="43">0</td>
